...
namespace Assets.Sources.Gameplay.World.StateMachine.States
{
    public class ChangeWorldState : IState
    {
        ...
        public ChangeWorldState(IInputService inputService, WindowsSwitcher windowsSwitcher, ActionHandlerStateMachine actionHandlerStateMachine, IUiFactory uiFactory)
        {
