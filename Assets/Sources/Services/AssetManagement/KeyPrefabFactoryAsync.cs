...
{
    public class KeyPrefabFactoryAsync<TComponent> : IFactory<string, UniTask<TComponent>>, IFactory<string, Vector3, Transform, UniTask<TComponent>>, IFactory<string, Transform, UniTask<TComponent>>
    {
